...
async def button_handler(update:Update,context:ContextTypes.DEFAULT_TYPE):
    ...
    elif query.data == "dolar_currency":
        await query.edit_message_text("💵 أدخل المبلغ لتحويله إلى دولار:")
        await query.message.reply_text("اختر نوع التحويل:", reply_markup=get_conversion_keyboard())
    elif query.data == "gold_currency":
        await query.edit_message_text("🥇 أدخل المبلغ لتحويله إلى ذهب:")
        await query.message.reply_text("اختر نوع التحويل:", reply_markup=get_conversion_keyboard())
